...
CREATE TABLE IF NOT EXISTS `ive`.`EMISORES` (
  ...
  `USUARIO_EMISOR` VARCHAR(10) NULL,
  `CONTRASENA_EMISOR` VARCHAR(10) NULL,
  `DIRECCION_EMISOR` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `ive`.`RECEPTORES` (
  ...
  `DIRECCION_RECEPTOR` VARCHAR(45) NULL,
  `TELEFONO_RECEPTOR` VARCHAR(8) NULL,
